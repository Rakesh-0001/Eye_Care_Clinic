      ...
      <div className="container">
        <div className="row gy-4 align-items-start">
          ...
          <div className="col-12 col-md-3 mb-3 mb-md-0 text-center text-md-start">
            <div className="eyecare-footer-logo mb-2">
          ...
          {/* Explore */}
          <div className="col-6 col-md-3 mb-3 mb-md-0 text-center text-md-start">
        ...
        <div className="row mt-4">
          <div className="col text-center eyecare-footer-copyright mt-4">
